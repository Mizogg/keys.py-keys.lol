# VIP_KEYS(old).py Random Bitcoin Legacy compressed/uncompresses addresses. Check 128 Addresses for Balance/transaction . Based on keys.lol 09/08/2021
# more control pick range at start
...
print(Fore.GREEN + "Start search...(Example Puzzle 64 starting Range 18446744073709551615 ) : ")
